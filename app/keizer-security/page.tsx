  ...
  return (
    <div>
      <HeroSection
        ...
        //   },
        // ]}
        backgroundImage="/security-hero.jpg"
      ...
      <div className="w-full py-10 max-w-7xl mx-auto">
          ...
          description={
            <div>
              <p className="text-black">
                McGee & Durrani Consulting is the dedicated security arm of
                Keizer Group, providing governments, corporations, and private
                clients with world-class protective services, training, and
        ...
        <StrategicImportance
          ...
          heading="Security That Enables Growth"
          image={{
            src: "/security-strategy.png",
          ...
          description={
            <div>
              ...
              <p className="text-gray-700 text-lg">
                In today’s volatile environment, security is not just about
                defense it is about enabling stability, confidence, and growth.
                McGee & Durrani brings unmatched expertise in intelligence,
                protection, and specialist training, making us the trusted
                partner for those who cannot compromise on safety.
              </p>
              <br></br>
              <p className="text-gray-700 text-lg">
                Operating as Keizer Group’s global security partner, McGee &
                Durrani Consulting integrates advanced intelligence,
                cutting-edge training, and operational excellence. Our services
                are designed to protect high-value individuals, safeguard
                critical infrastructure, and strengthen national security
                capabilities. 
              </p>
            </div>
          }
        ...
        <ClientsStakeholder
          ...
          items={[
            {
              title: "Government Agencies & Ministries of Defence / Interior -",
              description: "elite-level training and protective services.",
            },
            {
              title: "Corporate Clients & Multina -",
              description:
            ...
            },
            {
              ...
              description:
                "discreet, 24/7 personal security and protective services.",
            },
            {
              title: "Critical Infrastructure Operators -",
              description:
                " airports, ports, telecom hubs, and energy facilities.",
            },
          ]}
          columns={4}
        />

        <FullImage src="/security-image.png" alt="Keizer Medical Banner" />
        <div className="my-10">
          <HeadingWithLine
          ...
          <SectionCard
            ...
            //   alt: "Growth chart",
            // }}
            heading="Modern Training Approach"
            image={{
              src: "/medical-introduction.png",
              alt: "Medical professional with shield",
            }}
            ...
            description={
              <div>
                <p className="text-[#475467]">
                  McGee & Durrani’s training programs go beyond the basics. By
                  integrating dry fire technology with laser precision systems,
                  we create a safe, efficient, and modern training environment
                  that enhances reflexes, accuracy, and situational awareness.
                  This innovative approach reduces training costs while
                  maximizing performance.
                </p>
                <br></br>
                <p className="text-[#475467]">
                  Our programs focus on retention under pressure, tactical
                  decision-making, and rapid threat neutralization  equipping
                  trainees to respond effectively in real-world scenarios.
                </p>
              </div>
            }
          />
